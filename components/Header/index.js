                    ...
                    <Link href={user.displayName}>
                        <a>
                            <div className="flex bg-gray-750 py-1 px-4 rounded-lg items-center cursor-pointer">
                                ...
                                <div className={`h-8 w-8 relative overflow-hidden rounded-md mr-2 ${imageLoaded ? "block" : "hidden"}`}><Image layout="fill" src={user.photoURL} onLoad={() => setimageLoaded(true)}/></div>
                                <div>
