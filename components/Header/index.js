    ...
    return(
        <div className="flex items-center justify-between text-white">
            ...
            <div className="hidden md:flex md:items-center">
                <Link href="/search"><a><Image src="/search.svg" /></a></Link>
                    ...
                    <Link href={user.displayName}>
                        <a>
                            <div className="flex bg-gray-750 py-1 px-4 rounded-lg items-center cursor-pointer">
                                ...
                                <Image src={user.photoURL} className={`h-8 w-8 rounded-md mr-2 ${imageLoaded ? "block" : "hidden"}`} onLoad={() => setimageLoaded(true)}/>
                                <div>
